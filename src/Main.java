...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(nodesFile))) {
            br.readLine(); // Skip header line, no assignment needed
...
//                    for (Superhero s : superheroNodes) {
//                        if(Objects.equals(s.id, source)){
//                            for(Superhero s1 : superheroNodes){
//                                if(Objects.equals(s1.id, target)){
//                                    s.superheroes.add(s1);
//                                }
//                            }
//                        }
//                    }
        ...
        String date = ""; ArrayList<Superhero>  d_superheroes = new ArrayList<>();;
